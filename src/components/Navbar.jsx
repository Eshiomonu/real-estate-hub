...
const Navbar = () => {
  return (
    <div className="absolute top-0 left-o z-10 w-full">
      <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-36 bg-transparent">
      ...
      <div className="md:hidden fixed w-full right-0 top-0 bottom-0 overflow-hidden bg-white transition-all">
        <div className="flex justify-end p-6 cursor-pointer">
          <img src={assets.cross_icon} className="w-6" alt="" srcset="" />
        </div>
